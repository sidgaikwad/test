...
], GSTsController.prototype, "getCount", null);
GSTsController = __decorate([
    crud_1.Crud({
        model: {
            type: gst_entity_1.GST,
        },
    }),
    swagger_1.ApiTags('gst'),
    common_1.Controller('gst'),
    __metadata("design:paramtypes", [gst_service_1.GSTsService])
], GSTsController);
exports.GSTsController = GSTsController;
