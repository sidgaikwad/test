...
__decorate([
    swagger_1.ApiProperty({ type: 'float', nullable: false }),
    typeorm_1.Column({ type: 'float', nullable: false }),
    __metadata("design:type", Number)
], GST.prototype, "gstPercentage", void 0);
__decorate([
    swagger_1.ApiProperty({ nullable: false }),
    typeorm_1.CreateDateColumn(),
    __metadata("design:type", String)
], GST.prototype, "createdTimestamp", void 0);
__decorate([
    swagger_1.ApiProperty({ nullable: true }),
    typeorm_1.Column({ nullable: true }),
    __metadata("design:type", Number)
], GST.prototype, "createdBy", void 0);
__decorate([
    swagger_1.ApiProperty({ nullable: true }),
    typeorm_1.Column({ nullable: true }),
    __metadata("design:type", Number)
], GST.prototype, "updatedBy", void 0);
__decorate([
    swagger_1.ApiProperty({ nullable: false }),
    typeorm_1.UpdateDateColumn(),
    __metadata("design:type", String)
], GST.prototype, "updatedTimestamp", void 0);
GST = __decorate([
    typeorm_1.Entity({ name: 'gst' })
], GST);
exports.GST = GST;
