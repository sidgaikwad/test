...
], TransactionController.prototype, "getCount", null);
TransactionController = __decorate([
    crud_1.Crud({
        model: {
            type: trasaction_entity_1.Transaction,
        },
        query: {
            join: {
                tendor: {
